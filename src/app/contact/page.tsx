                                ...
                                <div ref={formRef} className="reveal-item w-full max-w-[550px] bg-slate-900/60 backdrop-blur-3xl px-10 py-12 sm:px-14 sm:py-16 rounded-[2.5rem] border border-white/20 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.8)] space-y-12 overflow-hidden relative group">
                                    ...
                                    <div className="space-y-8 relative z-10 font-figtree transition-all">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 font-figtree">
                                            ...
                                            <div className="space-y-3">
                                                <label className="text-[14px] font-medium text-white ml-1 font-figtree">Location</label>
                                                <input
                                                    type="text"
                                                    value={formData.location}
                                                    onChange={(e) => setFormData({ ...formData, location: e.target.value })}
                                                    className={`w-full px-5 py-4 rounded-lg bg-white/[0.03] border ${errors.location ? 'border-red-500/50' : 'border-white/10'} focus:border-blue-500/40 focus:bg-white/[0.05] outline-none transition-all text-white font-normal font-figtree`}
                                                />
