                        ...
                        <div className="relative w-full max-w-[600px] xl:max-w-[700px] z-0 mt-10 lg:mt-0">
                            ...
                            <div className="absolute top-[65%] left-0 sm:-left-4 xl:-left-12 bg-white/98 backdrop-blur-xl px-4 py-4 rounded-[20px] shadow-[0_24px_50px_-12px_rgba(121,77,0,0.2)] flex flex-col gap-4 min-w-[200px] animate-float border border-[#794d00]/5">
                                <div className="flex items-center gap-3">
                                    <img src="https://i.pravatar.cc/100?img=33" alt="Instructor" className="w-[42px] h-[42px] rounded-full border-2 border-slate-50 object-cover shadow-sm" />
                                    <div className="flex flex-col justify-center gap-0.5">
                                        <span className="font-bold text-[14px] text-slate-900 leading-tight">UI Design Class</span>
                                        <span className="text-[12px] font-medium text-slate-500">Today at 05:00 pm</span>
                                    </div>
                                </div>
                                <button className="w-full bg-[#794d00] text-white text-[13px] font-bold py-2.5 rounded-xl hover:bg-[#1e2a3b] hover:text-blue-500 transition-all shadow-md shadow-[#794d00]/20">
                                    Join now
                                </button>
                            </div>
